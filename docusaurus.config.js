...
const config = {
  title: 'AI/Spec-Driven Interactive Book',
  tagline: 'Physical AI and Embodied Intelligence Learning Platform',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} AI/Spec-Driven Interactive Book. Built with Docusaurus.`,
      },
      prism: {
